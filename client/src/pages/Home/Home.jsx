  ...
  return (
    <div id="home" className="Home page">
      ...
      <p className="landing-paragraph">
        Connecting Celestial Chronicles from Aryabhata to the Cosmos. Unveil the wonders of the universe with our website. Delve into the mysteries of celestial phenomena, explore the intricacies of distant galaxies, and witness the awe-inspiring beauty of our cosmos.
      </p>
        ...
        <div className="button-box">
          ...
          >
            <span className="button-icon">
              <img src={Instagram} alt="Instagram" /> &nbsp; FIND MORE
            </span>
          </a>
        </div>
        <div className="button-box">
          <a
            href="https://linktr.ee/antarikshnitkkr?utm_source=linktree_profile_share&ltsid=5645fcb7-dbd3-446a-9e52-9a081d687268"
